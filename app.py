...
def regenerate_carousel_cover(post_id):
    """Regenerate just the carousel cover with a different Refiloe look."""
    from social_media.carousel_template_generator import CarouselTemplateGenerator
    ...
    try:
        ...
        log_info(f"🎨 Regenerating cover with content_type: {content_type}")
        ...
        log_info(f"✅ Cover regenerated successfully for post {post_id}")
        ...
        return jsonify({
            'success': True,
            'message': f'Cover regenerated with {content_type} look',
